...
public class OtpLoginController {
    ...
    //  Replace with your actual 2Factor API key from https://2factor.in
    ...
    // Helper Method: Send OTP using 2Factor API
    private void sendOtpToPhone(String phone, String otp) {
        try {
            // Example URL → https://2factor.in/API/V1/{api_key}/SMS/{phone}/{otp}/{template_name}
